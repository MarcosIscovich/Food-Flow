...
export default component$(() => {
  ...
  const funcionalidades = [
    { id: 1, nombre: "Cobrar Mesa", icono: "fas fa-cash-register", class: "btn-func btn--verde " , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 2, nombre: "Reservar Mesa", icono: "fas fa-search", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 3, nombre: "Eliminar Mesa", icono: "fas fa-trash", class: "btn-func btn--rojo" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { eliminarMesaFlag.value = true }) },
    { id: 3, nombre: "Eliminar Producto", icono: "fas fa-trash", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { eliminarProductoFlag.value = true }) },
    { id: 4, nombre: "Mudar Mesa", icono: "fas fa-exchange-alt", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 5, nombre: "Dividir Mesa", icono: "fas fa-columns", class: "btn-func btn--azul", classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 6, nombre: "Agrupar Items", icono: "fas fa-object-group", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 7, nombre: "Marchar Comanda", icono: "fas fa-utensils", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { marcharComandaFlag.value = true }) },
    { id: 8, nombre: "Cambiar Camarero", icono: "fas fa-user-edit", class: "btn-func btn--azul", classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled" },
    { id: 12, nombre: "Editar Producto", icono: "fas fa-ban", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { cancelBtn.value = true }) },
    { id: 10, nombre: "Buscar Producto", icono: "fas fa-search", class: "btn-func btn--azul" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { modalBuscar.value = true }) },
    { id: 11, nombre: "Volver a Mesas", icono: "fas fa-ban", class: "btn-func btn--rojo" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { changeView.value = !changeView.value, cancelBtn.value = true }) },
    { id: 9, nombre: "Guardar Comanda", icono: "fas fa-save", class: "btn-func btn--verde" , classDisabled:"btn-funcDisabled btn--verdeDisabled btn-disabled", action: $(() => { guardarComandaFlag.value = true }) },
  ]
                      ...
                      {funcionalidades.map((funcionalidad, idx) => (
                        <div class="grid h-full" key={idx}>
                          <div class="w-full h-full">
                            <button class={changeView.value === true ? funcionalidad.class : funcionalidad.classDisabled} onClick$={() => { funcionalidad?.action() }}>
